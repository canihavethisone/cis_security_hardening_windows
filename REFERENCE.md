...
* `cis_security_hardening_windows::cis`: Windows cis class.  It is called from the cis_security_hardening_windows class.  Params are derived from in-module hiera and can be excluded.
* `cis_security_hardening_windows::remote_desktop`: Windows remote_desktop class.  It is called from the cis_security_hardening_windows class when $allow_remote_desktop is true.
